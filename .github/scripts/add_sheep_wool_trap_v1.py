...
# Update persistent trap zones in the main battle update before shots are filtered.
...
# movement slow: calculate from active zones in enemy movement scope near existing slow handling
...
# draw active wool zones before shots
zone_anchor='for(const s of battle.shots){'
