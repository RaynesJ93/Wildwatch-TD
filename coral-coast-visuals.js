// CORAL_COAST_VISUALS_V13 — global legacy-base suppression + top brand banner
(()=>{
 const coreDraw=draw,MAP_MAX=10;

 // Keep the new Critter Clash artwork ONLY in the existing top-left brand slot.
 function installTopBrandBanner(){
  ...
  img.src='assets/critter-clash-tower-defence-banner.png?v=13';
 ...
 // The original renderer in index.html still contains the old region bases.
 // Suppress only that final base drawing pass, for every region, without changing
 // enemies, towers, projectiles, map art, UI, progression or the new title banner.
 ...
 const s=document.createElement('script');s.src='regions-8-10.js?v=13';s.onload=()=>{const u=document.createElement('script');u.src='regions-8-10-ui.js?v=13';document.body.appendChild(u)};document.body.appendChild(s);
})();
